...
/**
 * A hook to fetch all features from all platforms for a given list of feature ids. "Expanding"
 * means that you might get back more features than you requested: Features can be **linked** to
 * other features (even from other APIs/DBs), and this hook will fetch those linked features as
 * well.
 *
