...
export const useAcToOsmFeatures = (
  ...
  const osmRelationProperties = { osmUris: [] as string[], requestProperties: { } as Record<string, FetchOneFeatureProperties> }
  for (const feature of features) {
    const guesstimatedRdfTypes = guesstimateRdfType(feature.feature.properties.sameAs ?? [])
