...
export const isLegacyOsmElementValue = (x: string): x is LegacyOsmId.WronglyTypedLegacyOsmId => matchLegacyOsmElementValue.test(x)

/**
 * Checks if a string conforms the **legacy** OSM address format of
 * - {@link LegacyOsmId.MongoDbOsmValue}
 * - {@link LegacyOsmId.WronglyTypedLegacyOsmId}
