...
import type {
  AccessibilityCloudRDFId,
  AccessibilityCloudURIParameterId,
} from "../brands/accessibilityCloudIds";

export const accessibilityCloudIdRegExp = new RegExp(
  `^(${AccessibilityCloudRDFTypes.join("|")})[/:]([0-9a-zA-Z]+)$`,
);
