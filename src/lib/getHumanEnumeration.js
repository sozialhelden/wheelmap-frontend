...
const conjunctionMap: ConjunctionMap = {
  or: {
    ...
    withSerialComma: <span className="conjunction" key="conjunction">{t` oder `}</span>,
    ...
    withoutSerialComma: <span className="conjunction" key="conjunction">{t` oder `}</span>
  },
  and: {
    ...
    withSerialComma: <span className="conjunction" key="conjunction">{t` und `}</span>,
    ...
    withoutSerialComma: <span className="conjunction" key="conjunction">{t` und `}</span>
  }
