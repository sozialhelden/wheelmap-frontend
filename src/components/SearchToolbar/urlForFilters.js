...
export default function urlForFilters({
  history,
  category,
  accessibilityFilter,
  toiletFilter,
  ...
  let newQueryParams: { [key: string]: ?string } = Object.assign({}, queryParams, {
    toilet: null,
    status: null,
  });
  ...
  location.pathname =
    category && category !== 'undefined' ? `/beta/categories/${category}` : `/beta`;
  return location;
}
