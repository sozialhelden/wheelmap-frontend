...
export default class PhotoUploadInstructionsToolbar extends React.Component<Props, State> {
  ...
  renderCloseLink() {
    ...
    aria-label={t`Schließen`} onClick={this.onClose} ref={backLink => this.backLink = backLink}>× </button>;
  }
  ...
  render() {
    ...
    const captions = {
      header: t`Die folgenden Bilder…`,
      content: t`…sind interessant für Rollstuhlgerechtigkeit.`,
      copyright: t`…habe ich gemacht.`,
      copyrightDetail: t`Mit meinem Upload übertrage ich Sozialhelden e.V. ein unbeschränktes Nutzungsrecht zum Veröffentlichen der Bilder unter der <a href="https://creativecommons.org/licenses/by-sa/4.0/legalcode" target="_blank">Creative Commons CC-BY-SA-Lizenz</a>.`,
      people: t`…zeigen keine Menschen.`,
      peopleDetail: t`Von identifizierbare Personen muss gemäß <a href="https://en.wikipedia.org/wiki/General_Data_Protection_Regulation" target="_blank">GDPR</a> schriftliches Einverständnis bestehen.`,
      guidelines: t`…entsprechen <a href="https://news.wheelmap.org/datenschutzerklaerung/" target="_blank">unseren Richtlinien</a>.`
    };
