...
export const PlaceholderSquare = styled(PlaceholderDiv)<{ size: string; color?: string }>`
  width: ${p => p.size};
  height: ${p => p.size};
  min-width: ${p => p.size};
  min-height: ${p => p.size};
...
export const PlaceholderCircle = styled(PlaceholderDiv)<{ size: string; color?: string }>`
  width: ${p => p.size};
  height: ${p => p.size};
