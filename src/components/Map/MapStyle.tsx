...
.is-android-platform
  ...
  .leaflet-icon-locate-loading:before {
  top: 7px;
  left: 7px;
  content: url(data:image/svg+xml;base64,);
}
...
@keyframes popUp {
  ...
  50% {
    transform: scale3d(0.75, 0.75, 0.75) translate3d(0, -20px, 0);
  }
  100% {
...
.ac-marker-green,
.ac-marker-green .ac-big-icon-marker {
...
.ac-marker-yellow,
.ac-marker-yellow .ac-big-icon-marker {
...
.ac-marker-red,
.ac-marker-red .ac-big-icon-marker {
  background-color: #f54b4b;
}

.ac-marker-red .ac-big-icon-marker:after,
.ac-marker-red .ac-big-icon-marker {
  background-color: #f54b4b;
}
...
@media (hover), (-moz-touch-enabled: 0) {
  .leaflet-marker-pane > .ac-marker:hover {
...
.ac-marker-cluster figure {
  display: flex;
  text-shadow: 0 0 1px rgba(0, 0, 0, 0.75);
}

@keyframes popUpHighlightCluster {
  0% {
    transform: scale3d(1, 1, 1) translate3d(0, 0px, 0);
  }
  50% {
  ...
  100% {
    transform: scale3d(2, 2, 2) translate3d(0, 0px, 0);
  }
}
.ac-marker-cluster.highlighted figure {
  animation: popUpHighlightCluster 0.2s ease;
  transform: scale3d(2, 2, 2) translate3d(0, 0px, 0);
}

.ac-marker-cluster.over-fifty figure {
  width: 40px !important;
  height: 40px !important;
}

.ac-marker-cluster.over-hundred figure {
  width: 50px !important;
  height: 50px !important;
}

.ac-marker-cluster.over-fivehundred figure {
...
.leaflet-bar {
  ...
  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2), 0 1px 2px rgba(0, 0, 0, 0.1) !important;
}
