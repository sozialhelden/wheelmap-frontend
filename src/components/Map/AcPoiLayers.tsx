...
import { useFilteredAccessibilityCloudTileUrl } from "~/modules/accessibility-cloud/hooks/useFilteredAccessibilityCloudTileUrl";
    ...
    (): LayerProps => ({
      ...
      layout: {
        "icon-size": [
          ...
          ["zoom"],
          6,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 3, 0.3],
          14,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 3, 0.5],
          16,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 3, 0.7],
          18,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 5, 3.2],
        ],
        "icon-image": `${wheelchairTag}WithoutArrow`,
        "icon-allow-overlap": true,
      },
      filter: ["all", ["==", ["get", "wheelchair"], wheelchairTag]],
    }),
...
export function MarkerIconLayer({
  ...
  source,
  sourceLayer,
}: { currentSelectedId?: string; source: string; sourceLayer: string }) {
  const staticProps = useMemo(
    (): LayerProps => ({
      ...
      layout: {
        ...
        "text-size": ["interpolate", ["linear"], ["zoom"], 0, 12, 22, 15],
        "text-anchor": "top",
        "text-offset": [0, 1],
        "icon-optional": false,
        "icon-allow-overlap": true,
        "icon-size": [
          ...
          ["zoom"],
          0,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 2, 0],
          16,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 2, 0],
          17,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 2, 1],
          22,
          ["case", ["==", ["get", "_id"], currentSelectedId || null], 4, 2.5],
        ],
      },
    }),
...
export const AcPoiLayers = () => {
  const tiles = [
    useFilteredAccessibilityCloudTileUrl({
