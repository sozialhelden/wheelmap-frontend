import { Button, ControlGroup, NonIdealState, Spinner } from "@blueprintjs/core"
...
export default function ProfilePanel() {
  ...
  if (status === "authenticated") {
    ...
    return (
      <ControlGroup vertical={true} style={{ margin: '2rem', alignItems: 'center' }}>
