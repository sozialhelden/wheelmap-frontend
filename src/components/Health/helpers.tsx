...
export const transferCityToBbox = (city: string) => {
  return `https://osm-api.wheelmap.tech/api/v1/admin.json?t[name]=~${city}&t[boundary]=administrative&bbox=5.98865807458,47.3024876979,15.0169958839,54.983104153`
};
