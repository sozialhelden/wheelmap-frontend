...
export default class CreatePlaceDialog extends React.Component<Props> {
  ...
  render() {
    ...
    const header = t`Ort hinzufügen`;
    const explanation = t`Die meisten Orte hier sind von <a href='https://openstreetmap.org'>OpenStreetMap (OSM)</a>. Wenn du dort neue Orte eingibst, erscheinen sie nach einer Weile auch hier.`;
    const leaveANoteCaption = t`Notiz auf OpenStreetMap hinterlassen`;
    const addOSMPlaceHeader = t`Ort auf OpenStreetMap hinzufügen`;
