...
export default function ChevronLeft(props) {
  return (<svg width="12px" height="30px" viewBox="0 0 24 59" version="1.1" {...props}>
    <g id="Page-1" stroke="none" strokeWidth="1" fill={colors.tonedDownSelectedColor} fillRule="evenodd">
