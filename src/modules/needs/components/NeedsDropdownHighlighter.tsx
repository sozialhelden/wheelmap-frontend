...
import { useNeedsHighlighterPosition } from "~/modules/needs/components/hooks/useNeedsHighlighterPosition";
import {
  type SectionRefSetter,
  useNeedsHighlighterRefs,
} from "~/modules/needs/components/hooks/useNeedsHighlighterRefs";
import type { NeedCategory } from "~/modules/needs/needs";
