export type TypeFilterOperator =
  ...
  | "to-string"
  | "typeof";
export type FeatureDataFilterOperator =
  | "accumulated"
  | "feature-state"
  | "geometry-type"
  | "id"
...
export type LookupFilterOperator =
  ...
  | "measure-light"
  | "slice";
export type DecisionFilterOperator =
  | "!"
  | "!="
  | "<"
  | "<="
  ...
  | "match"
  | "within";
export type RampFilterOperator =
  | "interpolate"
  | "interpolate-hcl"
  | "interpolate-lab"
  | "step";
...
export type MathFilterOperator =
  | "-"
  | "*"
  | "/"
  | "%"
...
export type FilterOperator =
  | TypeFilterOperator
  | FeatureDataFilterOperator
  | LookupFilterOperator
  | DecisionFilterOperator
  | RampFilterOperator
  | VariableBindingFilterOperator
